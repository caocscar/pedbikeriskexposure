...
1.2 Statement of hypotheses 3

2 Literature Review 3

2.1 Review of previous research 3

2.2 Summary of state-of-the-art 5

3 Methodology 6

3.1 Data Sources 8

3.1.1 Michigan Traffic Crash Facts 8

3.1.2 American Community Survey (ACS) 9

3.1.3 Public Use Microdata Sample (PUMS) 9

3.1.4 MI Travel Counts III (MTC III) 9

3.1.5 Reference USA 9

3.1.6 Highway Performance Monitoring System (HPMS) 9

3.2 Exposure Model 10

3.2.1 Unit of Analysis 10

3.2.2 Pedestrian Index of the Environment (PIE) 11

3.2.3 Trip Production Model 12

3.2.4 Destination Choice Model 13

3.2.5 Route choice 14
...
4.1 Summary of data 16

4.2 Method of analysis 17

4.2.1 Walk Trip Production 17

4.2.2 Destination Choice 18

4.3 Presentation of results 18

4.3.1 Exposure 18

4.3.2 Risk Score 19

4.3.3 Model Validation (10K cross validation) 20

5 Discussion 21

5.1 Validity of hypotheses 21

5.2 Factors affecting the results 21

5.2.1 Lack of side walk and bike lane data 21

5.2.2 Lack of manual count data 21

5.2.3 Limited sample size of the travel survey 21

5.2.4 Definition of “exposure to risk” 21

5.3 Implications 21

6 Conclusions 21

6.1 Conclusions from the study 21
...
6.2.3 Improve Safety performance function 22

6.3 Recommendations for implementation 22
...
8.2 List of Acronyms, Abbreviations and Symbols 23

8.3 Other Appendices 23

8.3.1 Experimental data 23

8.3.2 Analytical technique details 23

8.3.3 User Manuals 23

8.3.4 Other Deliverables 23

8.3.5 Synthetic Population and Iterated Proportional Fitting 23

8.3.6 ARC GIS Spatial Analysis 23

8.3.7 Pedestrian Index of Environment (PIE) 24

8.3.8 Bicyclist Index of Environment (BIE) 35

8.3.9 Destination Choice Model 38

8.3.10 Naturalistic Data for Pedestrians and Bicycles 38

8.3.11 User Interviews 47

8.3.12 Factors Associated with Frequency of Crashes 47



# List of Tables 

Table 1 Sample synthetic population with GEOID 261614032001 13

Table 3 Trip production estimates for home based other trips. 17

Table 4 Trip production estimates for non-home based other trips. 17

Table 5 Destination choice model results 18

# List of Figures
Figure 1. Methodology 6

Figure 2 Traditional Four Step Method 7

Figure 3 Modified Four Step Method 7

Figure 4 MI Counts Traveler and Household Data 9

Figure 5 Pedestrian Analysis Zone 10

Figure 6 Pedestrian Index of the Environment (PIE) 11

Figure 7 Destination model is based on sampling of real and possible destinations. 13

Figure 8 Route choice 15

Figure 9 Map of pedestrian exposure in Wayne County 19

Figure 10 Map of Pedestrian risk score in Wayne County 20

Figure 11 Destination Choice Model 34
...
1.  Report out methodology and results of this analysis.

2.  Produce a dataset for use in a GIS tool.
